...
| 14 | Trustworthy Agricultural Intelligence Under Data Sparsity: An Empirical Study of Evidence Availability, Uncertainty, and Reliability (redesigned 2026-09-17, see below) | Empirical | [`evidence-sparsity-reliability`](active_tests/evidence-sparsity-reliability/experiment_blueprint.md) (predecessor [`regional-equity-audit`](concluded/regional-equity-audit/experiment_blueprint.md), concluded) | | | Active — Phase 0's original scope built (5/5 modalities, `EvidenceQualityVector` scored, 2 real multi-year time series: price 157 obs, production 465 obs). 2026-09-19: **E1's first real forecast run** - annual (not yet 30-day, no modality has that granularity yet) next-year price forecasting, T0 (price alone) vs. T0+production, backtested on real held-out years for KE/RW x coffee/maize/tea (6 series, simple linear models, time-ordered split, no leakage). Real, honestly-mixed result: T0+production wins on all 4 aggregate metrics (MAPE 15.0%->14.3%, directional accuracy 0.49->0.57) but per-series picture is genuinely mixed (KE coffee/tea got worse; RW coffee improved substantially, MAPE 9.1%->5.4%) - a small, real, directionally-positive first data point for RQ1, not yet strong evidence given the small sample. Next: more series once weather/trade become real time series, or investigating the KE coffee/tea regressions specifically |
