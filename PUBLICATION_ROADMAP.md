...
| 14 | Trustworthy Agricultural Intelligence Under Data Sparsity: An Empirical Study of Evidence Availability, Uncertainty, and Reliability (redesigned 2026-09-17, see below) | Empirical | [`evidence-sparsity-reliability`](active_tests/evidence-sparsity-reliability/experiment_blueprint.md) (predecessor [`regional-equity-audit`](concluded/regional-equity-audit/experiment_blueprint.md), concluded) | | | Active — Phase 0 in progress: 3 of 4–5 evidence modalities fully collected live (price: 12 real observations, split by country tier; weather: 8 real observations via NASA POWER, uniform across all 4 countries; production: 12 real observations via FAOSTAT QCL, 2026-09-17/18 — uniform across countries but varies by commodity, maize tracked even for SS/SO while coffee/tea only tracked for KE/RW — unblocked by fixing 3 real production bugs in `services/forecasting/yield_prediction.py` found along the way, not yet merged to master pending project-owner go-ahead); trade built but blocked by a real UN Comtrade rate limit (a real F4 source-reliability-failure instance, not just an obstacle — retried 2026-09-18 00:59 UTC, still blocked, next earliest retry ~2026-09-18 03:00 UTC); textual/news-event modality not yet started |
