...
| 14 | Trustworthy Agricultural Intelligence Under Data Sparsity: An Empirical Study of Evidence Availability, Uncertainty, and Reliability (redesigned 2026-09-17, see below) | Empirical | [`evidence-sparsity-reliability`](active_tests/evidence-sparsity-reliability/experiment_blueprint.md) (predecessor [`regional-equity-audit`](concluded/regional-equity-audit/experiment_blueprint.md), concluded) | | | Active — Phase 0 in progress: 2 of 4–5 evidence modalities fully collected live 2026-09-17 (price: 12 real observations; weather: 8 real observations via NASA POWER, confirmed uniformly available across both country tiers unlike price); trade built but blocked mid-run by a real UN Comtrade rate limit (a real F4 source-reliability-failure instance, not just an obstacle — reopen after ~2026-09-18 03:00 UTC); production/textual-event modalities not yet started |
