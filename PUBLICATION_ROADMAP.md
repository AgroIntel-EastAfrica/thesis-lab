...
| 14 | Trustworthy Agricultural Intelligence Under Data Sparsity: An Empirical Study of Evidence Availability, Uncertainty, and Reliability (redesigned 2026-09-17, see below) | Empirical | [`evidence-sparsity-reliability`](active_tests/evidence-sparsity-reliability/experiment_blueprint.md) (predecessor [`regional-equity-audit`](concluded/regional-equity-audit/experiment_blueprint.md), concluded) | | | Active — Phase 0's original scope built (5/5 modalities collected live, `EvidenceQualityVector` scored across 56 observations). 2026-09-19: first real multi-year time series built for price (157 observations, KE 29-32 yrs/RW 13-30 yrs through 2024, SS/SO confirmed zero) - a genuine prerequisite for E1, discovered cheaply by reusing the same full-history-then-discard-to-latest pattern already found in production. Real finding: RW's coffee/tea price reporting stops at 2015 while maize continues to 2024, invisible in a single snapshot. E1 can now begin narrowly (price-only/T0, KE+RW) - production's own history is the next cheap follow-up; weather/trade/text remain single-snapshot |
