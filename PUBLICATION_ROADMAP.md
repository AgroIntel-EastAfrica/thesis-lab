...
| 14 | Trustworthy Agricultural Intelligence Under Data Sparsity: An Empirical Study of Evidence Availability, Uncertainty, and Reliability (redesigned 2026-09-17, see below) | Empirical | [`evidence-sparsity-reliability`](active_tests/evidence-sparsity-reliability/experiment_blueprint.md) (predecessor [`regional-equity-audit`](concluded/regional-equity-audit/experiment_blueprint.md), concluded) | | | Active — Phase 0's original scope built (5/5 modalities collected live, `EvidenceQualityVector` scored across 56 observations). 2026-09-19: two real multi-year time series now built. Price: 157 observations, KE 29-32 yrs/RW 13-30 yrs through 2024, SS/SO confirmed zero (real finding: RW's coffee/tea reporting stops at 2015 while maize continues to 2024). Production: 465 observations, KE/RW get FAOSTAT's full 64-year record (1961-2024) for all 3 commodities, SS/SO confirmed zero for coffee/tea across the entire 64-year window (never tracked, not a reporting gap). Both time series found "cheap" - both underlying FAOSTAT fetchers already had full history internally, just discarded to latest-year. E1 can now run price-only and price+production tiers for KE/RW. Weather/trade remain single-snapshot (need genuine new multi-date collection); text is structurally point-in-time |
